...
require_once '../../controller/productcontroller/productcontroller.php';

$data = new EqController();
$result = $data->index();

//if(isset($_POST['pay'])) {
 //   $data->destroy($_POST['pay']);
//}
            ...
            <tr>
               ...
               <br><br>
                    <form method="POST" action="">
                        <input type="hidden" name="pay" value="<?php echo $res['ProductID'] ?>">
                        <input type="submit" name="btnDelete" class="btn btn-primary pull-left" value="pay">
                    </form>
                    </td>
                </tr>
            </tr><?php } ?>
