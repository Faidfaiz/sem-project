            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="index.html"><img src="../../libs/img/core-img/llogo.png"style="width:100px" alt=" "></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                ...
                                <div class="book-now-btn ml-5 mt-4 mt-lg-0 ml-md-4" >
                                    <a href="../../view/home.php" class="btn akame-btn" >Log Out</a>
                                </div>
                            </div>
                            <!-- Nav End -->
                        </div>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Manage the registered accounts</h2>
                                    <p data-animation="fadeInUp" data-delay="400ms">Approve or reject the registered accounts to the system to allow users access the system or deny them. </p>
                                    <a href="#" class="btn akame-btn active" data-animation="fadeInUp" data-delay="700ms">Manage Accounts</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">Generate Reports</h2>
                                    <p data-animation="fadeInUp" data-delay="400ms">The system generates monthly reporting such as Supplier and Equipment Report, Event Report, Customer Report and Income Report.</p>
                                    <a href="#" class="btn akame-btn active" data-animation="fadeInUp" data-delay="700ms">Generate Reports</a>
                                </div>
                            </div>
                        </div>
                    </div>
