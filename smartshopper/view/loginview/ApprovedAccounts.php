...
$Approval_Date=array();
$Account_Type=array();
//get the returned value  from approve_view
$show = AccessController::approve_view();
foreach ($show as $row) {
...
<td><?php echo "<a href=Successfully.php?id1=",urlencode($Username[$i]),">" ?> <button  class="btn" type="button">Block</button> <?php "</a>" ?></td> 
