...
if (isset($_POST['update'])) {
    $result = $data->update($_POST['Username']);
}

if (isset($_GET['Username'])) {
  $result = $data->get($_GET['Username']);
}
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="SupplierHomeInterface.html"><img src="../../libs/img/core-img/logo.png" alt=""></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                 <ul id="nav">
                                    <li><a href="../SupplierInterface/SupplierHomeInterface.html">Home</a></li>
        ...
        <div class="card-body">
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="Username"  type="text" value="<?php echo $result['Username']; ?>">
                </div><br>
                <div class="form-group">
                    <label>Password : </label> 
                    <input class="form-control" name="Password"  type="text" value="<?php echo $result['Password']; ?>">
                </div><br>
                <div class="form-group">
                    <label>IC number : </label> 
                    <input class="form-control" name="ICno" type="text" value="<?php echo $result['ICno']; ?>">
                </div><br>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="ContactNo" type="number" value="<?php echo $result['ContactNo']; ?>">
                </div><br>
                <div class="form-group">
                    <label> Email : </label> 
                ...
                <div class="form-group">
                    <label>Company : </label> 
                    <input class="form-control" name="Company" type="text" value="<?php echo $result['Company']; ?>">
                </div><br>
                <div class="form-group">
                    <label>Gender : </label> 
                    <input class="form-control" name="Gender" type="text" value="<?php echo $result['Gender']; ?>">
                </div><br>
