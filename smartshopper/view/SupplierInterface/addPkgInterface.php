...
$data = new PkgController();//create object
        ...
        <div class="card-body">
            <form action="" method="post" role="form">
              ...
              <div class="form-group">
                ...
                <input class="form-control" name="PkgName" type="text">
              </div><br>

              <div class="form-group">
                <label>Package Description</label>
                <input class="form-control" name="PkgDesc"  type="text"> 
              </div><br>

              <div class="form-group">
                <label>Package Price (RM)</label> 
                <input class="form-control" name="PkgPrice" type="number">
              </div><br>
