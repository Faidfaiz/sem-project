...
<body>
    ...
    <section>
        ...
        <div class='right-button-margin'>
            <a href='addEqInterface.php' class='btn btn-primary m-b-1em'>Add New Product</a>
        </div><br>
        ...
        <div class="card-body table-responsive p-0">
            ...
            <tr>
                <tr>
                    ...
                    <td>
                    <a href="updateEqInterface.php?ProductID=<?php echo $res['ProductID']; ?>" class="btn btn-primary pull-left" style="margin-right: 5px">Update</a><br><br>
                    <form method="POST" action="">
                        <input type="hidden" name="delete" value="<?php echo $res['ProductID'] ?>">
