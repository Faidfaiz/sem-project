...
if (isset($_POST['update'])) {
    $result = $data->update($_POST['ProductID']);
}

if (isset($_GET['ProductID'])) {
  $result = $data->get($_GET['ProductID']);
}
        ...
        <div class="card-body">
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="ProductName"  type="text" value="<?php echo $result['ProductName']; ?>">
                </div><br>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="ProductPrice" type="number" value="<?php echo $result['ProductPrice']; ?>">
                </div><br>
                <div class="form-group">
                    <label>Product Description : </label> 
                    <input class="form-control" name="ProductDescription" type="text" value="<?php echo $result['ProductDescription']; ?>">
                </div><br>
                <div class="form-group">
