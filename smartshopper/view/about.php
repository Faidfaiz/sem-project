                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-7">
                        <div class="top-header-content text-right">
                            <p><i class="fa fa-clock-o" aria-hidden="true"></i><span id="date"></span> <span class="mx-2"></span> | <span class="mx-2"></span> <i class="fa fa-phone" aria-hidden="true"></i> Call us: (+60)-1137-555647</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="home.html"><img src="../libs/img/core-img/loog.png" alt=""></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li><a href="#">Login</a>
                                        <ul class="dropdown">
                                            <li><a href="loginview/Login.php">Login</a></li>
                                            <li><a href="loginview/Registration.php">Register Customer</a></li>
                                            <li><a href="loginview/S_Registration.php">Register Supplier</a></li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="#">Welcome to <br> Smartshopper</h2>
                                    <p data-animation="fadeInUp" data-delay="#">“SmartShopper application will provide a wide variety of products for the users to browse, check and buy an item or a collection of items.”</p>
                                </div>
                            </div>
                        </div>
                    </div>
